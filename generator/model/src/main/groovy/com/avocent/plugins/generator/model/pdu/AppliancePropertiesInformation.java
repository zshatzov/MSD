 ...
 *         &lt;element name="SysSecurityMode" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="SysPDUCount" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlType(name = "AppliancePropertiesInformationType", namespace = "http://www.emerson.com/CPGMIBMappingForPDUSchema", propOrder = {
    "sysObjectId",
    "sysDescription",
    "sysContact",
    "sysName",
...
public class AppliancePropertiesInformation {
    ...
    @XmlElement(name = "SysObjectId", namespace = "http://www.emerson.com/CPGMIBMappingForPDUSchema")
    protected String sysObjectId;
    @XmlElement(name = "SysDescription", namespace = "http://www.emerson.com/CPGMIBMappingForPDUSchema")
    protected String sysDescription;
    @XmlElement(name = "SysContact", namespace = "http://www.emerson.com/CPGMIBMappingForPDUSchema")
    protected String sysContact;
    @XmlElement(name = "SysName", namespace = "http://www.emerson.com/CPGMIBMappingForPDUSchema")
    protected String sysName;
    @XmlElement(name = "SysLocation", namespace = "http://www.emerson.com/CPGMIBMappingForPDUSchema")
    protected String sysLocation;
    @XmlElement(name = "SysSerialNo", namespace = "http://www.emerson.com/CPGMIBMappingForPDUSchema")
    protected String sysSerialNo;
    @XmlElement(name = "SysSecurityMode", namespace = "http://www.emerson.com/CPGMIBMappingForPDUSchema")
    protected String sysSecurityMode;
    @XmlElement(name = "SysPDUCount", namespace = "http://www.emerson.com/CPGMIBMappingForPDUSchema")
    protected String sysPDUCount;
    @XmlElement(name = "SysIdentModel", namespace = "http://www.emerson.com/CPGMIBMappingForPDUSchema")
    protected String sysIdentModel;
    @XmlElement(name = "SysVersion", namespace = "http://www.emerson.com/CPGMIBMappingForPDUSchema")
    ...
    /**
     * Gets the value of the sysSecurityMode property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getSysSecurityMode() {
        return sysSecurityMode;
    }

    /**
     * Sets the value of the sysSecurityMode property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setSysSecurityMode(String value) {
        this.sysSecurityMode = value;
    }

    /**
     * Gets the value of the sysPDUCount property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getSysPDUCount() {
        return sysPDUCount;
    }

    /**
     * Sets the value of the sysPDUCount property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setSysPDUCount(String value) {
        this.sysPDUCount = value;
    }
