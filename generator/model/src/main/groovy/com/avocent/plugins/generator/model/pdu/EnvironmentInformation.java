...
@XmlType(name = "EnvironmentInformationType", namespace = "http://www.emerson.com/CPGMIBMappingForPDUSchema", propOrder = {
...
public class EnvironmentInformation {
    ...
    @XmlElement(name = "EnvironmentTemperature", namespace = "http://www.emerson.com/CPGMIBMappingForPDUSchema", required = true)
    protected String environmentTemperature;
    @XmlElement(name = "TempUnitOfMeasurement", namespace = "http://www.emerson.com/CPGMIBMappingForPDUSchema", required = true)
    protected String tempUnitOfMeasurement;
    @XmlElement(name = "EnvironmentHumidity", namespace = "http://www.emerson.com/CPGMIBMappingForPDUSchema", required = true)
